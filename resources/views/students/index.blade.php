...
@section('action-button')
    <a href="{{ route('products.create') }}" class="btn btn-primary">Add New Student</a>
@endsection
            ...
            @foreach ($students as $student)
                <tr>
                    ...
                    <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <form style="display: inline;" action="{{ route('students.destroy', $product->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                        ...
                        <a href="{{ route('students.edit', $product->id) }}" class="btn btn-warning">Edit</a>
                        <a href="{{ route('students.show', $product->id) }}" class="btn btn-info">Show</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
